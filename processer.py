...
def Process():
    ...
    for ind in df.index:
        data_list.append([ df["month_1"][ind], df["month_2"][ind], df["month_3"][ind], df["day_off"][ind], df["avalanche"][ind], 
                        df["DangerLevel"][ind], df["Nedbor"][ind], df["Vindstyrke"][ind], df["Temperatur_mean"][ind], 
                        df["AvalProbabilityId_0"][ind], df["AvalProbabilityId_3"][ind], df["AvalProbabilityId_5"][ind], 
                        df["AvalProbabilityId_7"][ind], df["AvalProbabilityId_10"][ind], df["AvalProbabilityId_30"][ind], 
                        df["AvalProbabilityId_45"][ind], df["AvalProbabilityId_50"][ind] ]) 
    ...
    df_processed_data.columns = ['month_1', 'month_2', 'month_3', 'day_off', 'avalanche', 'danger_level', 'nedbor', 'vind_styrke', 'temperatur_mean',
                                'aval_probability_id_0', 'aval_probability_id_3', 'aval_probability_id_5', 'aval_probability_id_7', 'aval_probability_id_10', 
                                'aval_probability_id_30', 'aval_probability_id_45', 'aval_probability_id_50']
